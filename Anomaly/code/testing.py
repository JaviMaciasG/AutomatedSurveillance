import Anomaly.code.motionInfuenceGenerator as mig
import Anomaly.code.createMegaBlocks as cmb
import numpy as np
import cv2
...
def test_video(vid):
    ...
    np.save(r"mypath\Dataset\videos\scene1\megaBlockMotInfVal_set1_p1_test_20-20_k5.npy",megaBlockMotInfVal)
    ######megaBlockMotInfVal = np.load("megaBlockMotInfVal_set3_p2_train_40_k7.npy")
    codewords = np.load(r"mypath\Dataset\videos\scene1\codewords_set2_p1_train_20-20_k5.npy")
...
if __name__ == '__main__':
    ...
    '''
    testSet = [r"/home/mypath/darknet-master/Anomaly/Dataset/vids/videos/scene2/2_test1.avi"]
