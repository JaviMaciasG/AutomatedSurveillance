...
#variasmochilas014
    ...
    net = darknet.load_net(b"/mypath/darknet-master/cfg/yolov3.cfg",b"/mypath/darknet-master/cfg/yolov3.weights", 0)
    meta = darknet.load_meta(b"/mypath/darknet-master/cfg/coco.data")
    ...
    for stri in files:
        ...
        if (first_iteration_indicator == 1):
            ...
            darknet.saveimage(fgmask, "test", '/mypath/darknet-master/Heatmap',0)
            ...
            darknet.saveimage(fgmask, "test2", '/mypath/darknet-master/Heatmap',0)
            ...
            darknet.saveimage(th1, "test3", '/mypath/darknet-master/Heatmap',0)
            # for testing purposes, show the threshold image
            #cv2.imwrite('temp/diff-th1.jpg', th1)
            #darknet.saveimage(th1,heatmapframes,'/mypath/darknet-master/Heatmap/temp')
            ...
            if (cycle == 0):
                ...
                darknet.saveimage(th1,heatmapframes,'/mypath/darknet-master/Heatmap/temp',0)
            ...
            files2 = getfiles('/mypath/darknet-master/Heatmap/temp',0)
            ...
            for stri2 in files2:
                ...
                darknet.saveimage(newthgray, "befacu", '/mypath/darknet-master/Heatmap',0)
            ...
            darknet.saveimage(accum_image,"acc","/mypath/darknet-master/Heatmap",0)
            ...
            darknet.saveimage(result_overlay,framespassed,'/mypath/darknet-master/resultsheat',0)
